...
| Token 认证 | 安全登录验证 |
| 登录安全 | 2FA 双因素认证、登录 IP 白名单、失败次数锁定 |
...
| Login Security | 2FA, login IP whitelist, failure lockout |
...
| Announcement Read | Server-side read-status tracking |

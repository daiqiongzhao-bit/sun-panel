...
import (
	...
	"sun-panel/initialize/permission"
...
func DatabaseConnect() {
	...
	if err := permission.InitDefaultPermissions(); err != nil {
		global.Logger.Errorln("Permission initialization error", err)
	} else {
		global.Logger.Infoln("Permission initialization completed")
	}
}
